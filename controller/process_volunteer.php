...
$firstnameError = $lastnameError = $emailError = $passwordError = $genderError = $divisionError = $pnoError = $enoError = $imageError = $institutionError = $joindateError = "";
if (isset($_REQUEST["submit_button"])) {
    ...
    $existingdata = file_get_contents("../data/voljsondata.json");
    ...
    if (file_put_contents("../data/voljsondata.json", $jsondata)) {
