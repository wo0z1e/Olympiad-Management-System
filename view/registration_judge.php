<?php 
include("../controller/process_judge.php");
...
<table>
        <form action="" method="post">
            ...
            <tr>
                ...
                <td> <input type="text" id="org" name="org"> <?php ; ?></td>
            </tr>
            <tr>
                <td><label for="proftitle">Professional Title :</label></td>
                <td><input type="text" id="proftitle" name="proftitle"><?php  ;?></td>
            </tr>
            <tr>
                <td><label for="profexp">Professional Experience :</label></td>
                <td><input type="text" id="profexp" name="profexp" ></td>
            </tr>
            <tr>
